<%@ page title="Phòng ban" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Phongban, App_Web_sjyzhvtb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" 
        AutoGenerateColumns="False" Width="812px" Caption="DANH SÁCH PHÒNG BAN" 
        ...
        <Columns>
            ...
            <dxwgv:GridViewDataTextColumn Caption="Mã phòng ban" FieldName="_id" 
                VisibleIndex="1" Width="150px">
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="Tên phòng ban" FieldName="tenpb" 
                VisibleIndex="2">
            </dxwgv:GridViewDataTextColumn>
        </Columns>
    </dxwgv:ASPxGridView>
